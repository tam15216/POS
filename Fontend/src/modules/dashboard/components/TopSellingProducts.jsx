          ...
          <table className="w-full text-left border-collapse">
            <thead className="sticky top-0 z-10 bg-white">
              <tr className="text-sm font-semibold text-purple-700 border-b border-purple-50">
                <th className="pb-3 pl-2 bg-white">สินค้า</th>
                <th className="pb-3 text-center bg-white">จำนวนที่ขายได้</th>
                <th className="pb-3 pr-2 text-right bg-white">สร้างรายได้</th>
              </tr>
            </thead>
